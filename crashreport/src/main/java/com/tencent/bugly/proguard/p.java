...
public final class p {
        ...
        public final void run() {
            switch (this.a) {
                ...
                case com.tencent.bugly.BuglyStrategy.a.CRASHTYPE_ANR /*4*/:
                    ...
                    return;
                case com.tencent.bugly.BuglyStrategy.a.CRASHTYPE_COCOS2DX_JS /*5*/:
                    p.this.a(this.o, this.b);
                    return;
                case com.tencent.bugly.BuglyStrategy.a.CRASHTYPE_COCOS2DX_LUA /*6*/:
    ...
    private p(Context context, List<BuglyDatabase> list) {
        b = new q(context, list);
    }

    public static synchronized p a(Context context, List<BuglyDatabase> list) {
        p pVar;
    ...
    public java.util.Map<java.lang.String, byte[]> a(int r5, com.tencent.bugly.proguard.o r6) {
        /*
            r4 = this;
            r0 = 0
            java.util.List r1 = r4.c(r5)     // Catch:{ Throwable -> 0x003a }
    ...
    public final synchronized java.util.List<com.tencent.bugly.proguard.r> a(int r10) {
        ...
        L_0x003c:
            ...
            com.tencent.bugly.proguard.r r4 = a(r2)     // Catch:{ Throwable -> 0x004c, all -> 0x0082 }
    ...
    private synchronized java.util.List<com.tencent.bugly.proguard.r> c(int r10) {
        ...
        L_0x0038:
            ...
            com.tencent.bugly.proguard.r r5 = b(r2)     // Catch:{ Throwable -> 0x0048, all -> 0x007e }
