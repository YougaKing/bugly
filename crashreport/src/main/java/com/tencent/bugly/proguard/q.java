...
public final class q extends SQLiteOpenHelper {
    ...
    private Context c;
    private List<BuglyDatabase> d;

    public q(Context context, List<BuglyDatabase> list) {
    ...
    public final synchronized void onCreate(SQLiteDatabase sQLiteDatabase) {
        ...
        if (this.d != null) {
            for (BuglyDatabase onDbCreate : this.d) {
                try {
    ...
    public final synchronized void onUpgrade(SQLiteDatabase sQLiteDatabase, int i, int i2) {
        ...
        if (this.d != null) {
            for (BuglyDatabase onDbUpgrade : this.d) {
                try {
    ...
    public final synchronized void onDowngrade(SQLiteDatabase sQLiteDatabase, int i, int i2) {
        if (b.c() >= 11) {
            ...
            if (this.d != null) {
                for (BuglyDatabase onDbDowngrade : this.d) {
                    try {
