...
public final class a {
    ...
    private a(Context context) {
        ...
        if (d2 != null) {
            try {
                ...
                String str6 = (String) d2.get("BUGLY_APP_BUILD_NO");
                if (!TextUtils.isEmpty(str6)) {
                    Integer.parseInt(str6);
                }
                String str7 = (String) d2.get("BUGLY_AREA");
                if (str7 != null) {
                    this.z = str7;
                }
            } catch (Throwable th2) {
    ...
    public final String t() {
        try {
            Map all = this.H.getSharedPreferences("BuglySdkInfos", 0).getAll();
            if (!all.isEmpty()) {
                synchronized (this.aw) {
    ...
    public final String f(String str) {
        ...
        synchronized (this.ax) {
            str2 = (String) this.ak.remove(str);
        }
        return str2;
    }
