...
public final class a {
    ...
    private final List<BuglyDatabase> c;
    private final w d;
    ...
    private a(Context context, List<BuglyDatabase> list) {
        this.g = context;
    ...
    public static synchronized a a(Context context, List<BuglyDatabase> list) {
        a aVar;
        ...
        this.d.a(new Thread() {
            public final void run() {
                try {
                    ...
                    if (a2 != null) {
                        byte[] bArr = (byte[]) a2.get("device");
                        byte[] bArr2 = (byte[]) a2.get("gateway");
                        if (bArr != null) {
        ...
        if (asVar != null) {
            if (this.f == null || asVar.h != this.f.p) {
                ...
                if (asVar.g != null && asVar.g.size() > 0) {
                    ...
                    String str4 = (String) asVar.g.get("B25");
