...
public final class a implements NativeExceptionHandler {
    ...
    public final CrashDetailBean packageCrashDatas(String str, String str2, long j, String str3, String str4, String str5, String str6, String str7, String str8, String str9, String str10, String str11, byte[] bArr, Map<String, String> map, boolean z, boolean z2) {
        ...
        String a2 = b.a(str12, str8);
        if (!z.a(a2)) {
            crashDetailBean.V = a2;
        }
        crashDetailBean.W = b.b(str12);
        ...
        if (z) {
            ...
            String str13 = "java:\n";
            int indexOf = crashDetailBean.q.indexOf(str13);
            if (indexOf > 0) {
                int length = indexOf + str13.length();
                if (length < crashDetailBean.q.length()) {
                    ...
                    if (substring.length() > 0 && crashDetailBean.z.containsKey(crashDetailBean.B)) {
                        String str14 = (String) crashDetailBean.z.get(crashDetailBean.B);
                        int indexOf2 = str14.indexOf(substring);
                        if (indexOf2 > 0) {
                            String substring2 = str14.substring(indexOf2);
        ...
        try {
            ...
            if (str16 == null || str16.length() == 0) {
                ...
                while (true) {
                    ...
                    if (thread.getName().equals(str16)) {
                        str11 = str16 + "(" + thread.getId() + ")";
                        z = true;
                        break;
                    }
                }
            ...
            if (this.d.c().g || !this.d.b()) {
                CrashDetailBean packageCrashDatas = packageCrashDatas(str10, str11, j3, str9, str2, a2, str8, str12, str4, str17, str18, str7, null, null, true, z2);
